/*******************************************************************************
* Created by linybear from DPRC++ (The Democratic People's Republic of C++).   *
* This is version 2.1 of hangman
*******************************************************************************/
#include <iostream>
#include <string>
#include <ctime>
...
//function code
void gameStart() {
	char usrChar, posFinder; //for input
